      ...
      <div className="relative w-full max-w-lg bg-zinc-950 rounded-t-3xl shadow-2xl slide-up flex flex-col"
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-5 py-5 space-y-6">
          ...
          {draft.type === 'weekly' && draft.subGoals.length === 0 && (
            <div>
              <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block mb-2">Weekly target</label>
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800">
                  <button type="button"
                    ...
                    className="w-12 h-12 flex items-center justify-center text-zinc-400 hover:text-white text-xl transition-colors select-none">−</button>
