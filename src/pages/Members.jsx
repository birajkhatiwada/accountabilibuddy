    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-zinc-900 border border-zinc-700 rounded-xl px-4 py-3 text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-emerald-600 transition-colors"
        />
        <button
          onClick={addMember}
      ...
      {members.length === 0 && (
        <div className="text-center py-12 text-zinc-600">
          ...
          <p className="font-medium text-zinc-400">No members yet</p>
      ...
      <div className="space-y-2">
        {members.map(name => (
          <div key={name} className="flex items-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3">
